                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-2">
                                <div class="logo">
                                    <a href="index.html"><img src="source/assets/logo/AmBakeryTextLogo.svg" alt="" style="height: fit;"/></a>
                                </div>
                            </div>
                            <!--  Logo Area end-->
                                        ...
                                        <li class="menu-dropdown">
                                            ...
                                            <ul class="mega-menu-wrap">
                                                ...
                                                <li class="banner-wrapper">
                                                    <a href="single-product.html"><img src="source/assets/images/banner-image/banner-menu.jpg" alt="" /></a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="menu-dropdown">
                                                ...
                                                <ul>
                                                    <li class="single-shopping-cart">
                                                        <div class="shopping-cart-img">
                                                            <a href="single-product.html"><img alt="" src="source/assets/images/product-image/mini-cart/1.jpg" /></a>
                                                    ...
                                                    <li class="single-shopping-cart">
                                                        <div class="shopping-cart-img">
                                                            <a href="single-product.html"><img alt="" src="source/assets/images/product-image/mini-cart/2.jpg" /></a>
                                                            <span class="product-quantity">1x</span>
                                                        </div>
                                                        <div class="shopping-cart-title">
